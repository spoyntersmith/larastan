...
class IntegrationTest extends PHPStanTestCase
{
    ...
    public static function dataIntegrationTests(): iterable
    {
        ...
        yield [
            ...
            [
                4 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Relations\HasMany<App\Account,App\User>::where() expects array<int|model property of App\Account, mixed>|(Closure(Illuminate\Database\Eloquent\Relations\HasMany<App\Account, App\User>): Illuminate\Database\Eloquent\Relations\HasMany<App\Account, App\User>)|(Closure(Illuminate\Database\Eloquent\Relations\HasMany<App\Account, App\User>): void)|Illuminate\Contracts\Database\Query\Expression|model property of App\Account, \'foo\' given.'],
                ...
                10 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Relations\BelongsToMany<App\Post,App\User>::where() expects array<int|model property of App\Post, mixed>|(Closure(Illuminate\Database\Eloquent\Relations\BelongsToMany<App\Post, App\User>): Illuminate\Database\Eloquent\Relations\BelongsToMany<App\Post, App\User>)|(Closure(Illuminate\Database\Eloquent\Relations\BelongsToMany<App\Post, App\User>): void)|Illuminate\Contracts\Database\Query\Expression|model property of App\Post, \'foo\' given.'],
